...
data_params.savedir = ['./feature/train_' 'dep_lbp'];
...
if featag
   ...
   save -v7.3 ./feature/fea_dep_lbpkdes rgbdfea rgbdclabel rgbdilabel basis_params;
else
   load ./feature/fea_dep_lbpkdes;
end

fea= load('./feature/fea_dep_lbpkdes');
...
save -v7.3  ./model/dep_lbp_model trainobj;
